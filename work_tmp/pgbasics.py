...
'''
    ...
    def mettre_en_place_serveur_distant_fdw(self, hote_distant, base_distante, port, utilisateur, motdepasse, nom_serveur_distant):
        ...
        self.effacer_serveur_distant_fdw(nom_serveur_distant)        
        self.creer_serveur_distant_fdw(hote_distant, base_distante, port, nom_serveur_distant)
        self.effacer_user_mapping_pour_serveur_distant_fdw(utilisateur, nom_serveur_distant) 
    ...
    def copier_table_distante(self, hote_distant, base_distante, port, utilisateur, motdepasse, schema_initial, table_initiale, schema_final, table_finale):
        ...
        self.mettre_en_place_serveur_distant_fdw(hote_distant, base_distante, port, utilisateur, motdepasse, nom_serveur_temporaire)
        ...
        self.creer_table_etrangere(schema_final, table_finale + '_fdw', schema_initial, table_initiale, champs, nom_serveur_temporaire) 
        ...
        self.effacer_user_mapping_pour_serveur_distant_fdw(utilisateur, nom_serveur_temporaire)
        self.effacer_serveur_distant_fdw(nom_serveur_temporaire)
        self.deconnecter() # permettre de'effacer la connexion postgres_fdw qui sinon restera en attente inutilement
