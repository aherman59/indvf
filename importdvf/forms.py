...
class ConfigForm(forms.Form):
    ...
    geolocaliser = forms.BooleanField(required = False, label='Géométries (1)', widget = forms.CheckboxInput(attrs={'class':"checkbox disabled", 'disabled':True,}))
    proxy = forms.CharField(label='Proxy (1)', validators=[URLValidator], required=False, max_length = 255, widget = forms.TextInput(attrs={'class':"form-control", 'disabled':True, 'placeholder':"http://proxy.example.fr - laisser vide dans un premier temps"}))
