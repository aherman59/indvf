...
--
-- Début d'exécution le 13/05/2016 à 09:50:46
---
...
LEFT JOIN dvf_d59.tmp_calcul_annexes_idmutation t5
	ON t.idmutation = t5.idmutation
LEFT JOIN dvf_d59.tmp_calcul_local_idmutation t6
	ON t.idmutation = t6.idmutation
LEFT JOIN dvf_d59.tmp_calcul_mutation_article_cgi_idmutation t7
...
LEFT JOIN dvf_d62.tmp_calcul_ann_nature_mutation_idmutation t1
	ON t.idmutation = t1.idmutation
LEFT JOIN dvf_d62.tmp_calcul_disposition_parcelle_idmutation t2
	ON t.idmutation = t2.idmutation
LEFT JOIN dvf_d62.tmp_calcul_suf_idmutation t3
	ON t.idmutation = t3.idmutation
LEFT JOIN dvf_d62.tmp_calcul_disposition_idmutation t4
	ON t.idmutation = t4.idmutation
LEFT JOIN dvf_d62.tmp_calcul_annexes_idmutation t5
	ON t.idmutation = t5.idmutation
LEFT JOIN dvf_d62.tmp_calcul_local_idmutation t6
	ON t.idmutation = t6.idmutation
LEFT JOIN dvf_d62.tmp_calcul_mutation_article_cgi_idmutation t7
	ON t.idmutation = t7.idmutation
);
SELECT tablename 
FROM pg_tables 
