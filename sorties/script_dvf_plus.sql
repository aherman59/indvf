...
--
-- Début d'exécution le 04/08/2016 à 16:22:39
---
...
LEFT JOIN dvf_d59.tmp_calcul_disposition_parcelle_idmutation t3
	ON t.idmutation = t3.idmutation
LEFT JOIN dvf_d59.tmp_calcul_disposition_idmutation t4
	ON t.idmutation = t4.idmutation
LEFT JOIN dvf_d59.tmp_calcul_ann_nature_mutation_idmutation t5
	ON t.idmutation = t5.idmutation
LEFT JOIN dvf_d59.tmp_calcul_mutation_article_cgi_idmutation t6
...
LEFT JOIN dvf_d62.tmp_calcul_suf_idmutation t2
	ON t.idmutation = t2.idmutation
LEFT JOIN dvf_d62.tmp_calcul_disposition_parcelle_idmutation t3
	ON t.idmutation = t3.idmutation
LEFT JOIN dvf_d62.tmp_calcul_disposition_idmutation t4
	ON t.idmutation = t4.idmutation
LEFT JOIN dvf_d62.tmp_calcul_ann_nature_mutation_idmutation t5
	ON t.idmutation = t5.idmutation
LEFT JOIN dvf_d62.tmp_calcul_mutation_article_cgi_idmutation t6
	ON t.idmutation = t6.idmutation
...
SELECT setval(pg_get_serial_sequence('dvf.local_plus','iddispoloc')::TEXT, 792916);
...
SELECT setval(pg_get_serial_sequence('dvf.disposition_parcelle_plus','iddispopar')::TEXT, 1040306);
