...
--
-- Début d'exécution le 07/06/2016 à 20:51:11
---
...
LEFT JOIN dvf_d59.tmp_calcul_mutation_article_cgi_idmutation t0
	ON t.idmutation = t0.idmutation
LEFT JOIN dvf_d59.tmp_calcul_disposition_idmutation t1
	ON t.idmutation = t1.idmutation
LEFT JOIN dvf_d59.tmp_calcul_annexes_idmutation t2
...
LEFT JOIN dvf_d59.tmp_calcul_local_idmutation t6
...
LEFT JOIN dvf_d62.tmp_calcul_mutation_article_cgi_idmutation t0
	ON t.idmutation = t0.idmutation
LEFT JOIN dvf_d62.tmp_calcul_disposition_idmutation t1
	ON t.idmutation = t1.idmutation
LEFT JOIN dvf_d62.tmp_calcul_annexes_idmutation t2
	ON t.idmutation = t2.idmutation
...
LEFT JOIN dvf_d62.tmp_calcul_ann_nature_mutation_idmutation t5
	ON t.idmutation = t5.idmutation
LEFT JOIN dvf_d62.tmp_calcul_local_idmutation t6
	ON t.idmutation = t6.idmutation
...
SELECT setval(pg_get_serial_sequence('dvf.local_plus','iddispoloc')::TEXT, 83141);
...
ALTER TABLE dvf_d59.local_plus RENAME CONSTRAINT local_plus_pkey TO local_pkey;
ALTER TABLE dvf_d59.local_plus RENAME CONSTRAINT local_plus_unique TO local_unique;
ALTER TABLE dvf_d59.local_plus RENAME CONSTRAINT local_plus_check TO local_check;
ALTER TABLE dvf_d59.local_plus RENAME To local;

DROP TABLE IF EXISTS dvf_d62.local CASCADE;

ALTER TABLE dvf_d62.local_plus RENAME CONSTRAINT local_plus_pkey TO local_pkey;
ALTER TABLE dvf_d62.local_plus RENAME CONSTRAINT local_plus_unique TO local_unique;
ALTER TABLE dvf_d62.local_plus RENAME CONSTRAINT local_plus_check TO local_check;
...
SELECT setval(pg_get_serial_sequence('dvf.disposition_parcelle_plus','iddispopar')::TEXT, 105851);
...
ALTER TABLE dvf_d59.disposition_parcelle_plus RENAME CONSTRAINT disposition_parcelle_plus_pkey TO disposition_parcelle_pkey;
ALTER TABLE dvf_d59.disposition_parcelle_plus RENAME CONSTRAINT disposition_parcelle_plus_unique TO disposition_parcelle_unique;
ALTER TABLE dvf_d59.disposition_parcelle_plus RENAME CONSTRAINT disposition_parcelle_plus_check TO disposition_parcelle_check;
...
ALTER TABLE dvf_d62.disposition_parcelle_plus RENAME CONSTRAINT disposition_parcelle_plus_pkey TO disposition_parcelle_pkey;
ALTER TABLE dvf_d62.disposition_parcelle_plus RENAME CONSTRAINT disposition_parcelle_plus_unique TO disposition_parcelle_unique;
ALTER TABLE dvf_d62.disposition_parcelle_plus RENAME CONSTRAINT disposition_parcelle_plus_check TO disposition_parcelle_check;
...
SELECT setval(pg_get_serial_sequence('dvf.mutation_plus','idmutation')::TEXT, 71065);
...
ALTER TABLE dvf_d59.mutation_plus RENAME CONSTRAINT mutation_plus_pkey TO mutation_pkey;
ALTER TABLE dvf_d59.mutation_plus RENAME CONSTRAINT mutation_plus_unique TO mutation_unique;
ALTER TABLE dvf_d59.mutation_plus RENAME CONSTRAINT mutation_plus_check TO mutation_check;
ALTER TABLE dvf_d59.mutation_plus RENAME To mutation;

DROP TABLE IF EXISTS dvf_d62.mutation CASCADE;

ALTER TABLE dvf_d62.mutation_plus RENAME CONSTRAINT mutation_plus_pkey TO mutation_pkey;
ALTER TABLE dvf_d62.mutation_plus RENAME CONSTRAINT mutation_plus_unique TO mutation_unique;
ALTER TABLE dvf_d62.mutation_plus RENAME CONSTRAINT mutation_plus_check TO mutation_check;
