...
LEFT JOIN dvf_d59.tmp_calcul_annexes_idmutation t0
	ON t.idmutation = t0.idmutation
LEFT JOIN dvf_d59.tmp_calcul_volume_idmutation t1
...
LEFT JOIN dvf_d59.tmp_calcul_ann_nature_mutation_idmutation t7
...
CREATE INDEX IF NOT EXISTS l_codinsee_idx_gin ON dvf_d59.mutation USING GIN (l_codinsee);
