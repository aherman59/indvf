...
--
-- Début d'exécution le 24/11/2016 à 22:27:34
---
...
LEFT JOIN dvf_d62.tmp_calcul_disposition_parcelle_idmutation t1
	ON t.idmutation = t1.idmutation
LEFT JOIN dvf_d62.tmp_calcul_disposition_idmutation t2
	ON t.idmutation = t2.idmutation
LEFT JOIN dvf_d62.tmp_calcul_ann_nature_mutation_idmutation t3
	ON t.idmutation = t3.idmutation
LEFT JOIN dvf_d62.tmp_calcul_suf_idmutation t4
...
LEFT JOIN dvf_d62.tmp_calcul_local_idmutation t7
...
LEFT JOIN dvf_d59.tmp_calcul_volume_idmutation t0
	ON t.idmutation = t0.idmutation
LEFT JOIN dvf_d59.tmp_calcul_disposition_parcelle_idmutation t1
	ON t.idmutation = t1.idmutation
LEFT JOIN dvf_d59.tmp_calcul_disposition_idmutation t2
	ON t.idmutation = t2.idmutation
LEFT JOIN dvf_d59.tmp_calcul_ann_nature_mutation_idmutation t3
	ON t.idmutation = t3.idmutation
LEFT JOIN dvf_d59.tmp_calcul_suf_idmutation t4
	ON t.idmutation = t4.idmutation
LEFT JOIN dvf_d59.tmp_calcul_mutation_article_cgi_idmutation t5
	ON t.idmutation = t5.idmutation
LEFT JOIN dvf_d59.tmp_calcul_annexes_idmutation t6
	ON t.idmutation = t6.idmutation
LEFT JOIN dvf_d59.tmp_calcul_local_idmutation t7
	ON t.idmutation = t7.idmutation
);
SELECT tablename 
FROM pg_tables 
...
SELECT setval(pg_get_serial_sequence('dvf.local_plus','iddispoloc')::TEXT, 802585);
...
SELECT setval(pg_get_serial_sequence('dvf.disposition_parcelle_plus','iddispopar')::TEXT, 1040409);
...
SELECT setval(pg_get_serial_sequence('dvf.mutation_plus','idmutation')::TEXT, 690383);
