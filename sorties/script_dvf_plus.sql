...
--
-- Début d'exécution le 11/07/2016 à 20:47:12
---
...
LEFT JOIN dvf_d62.tmp_calcul_mutation_article_cgi_idmutation t3
	ON t.idmutation = t3.idmutation
LEFT JOIN dvf_d62.tmp_calcul_disposition_parcelle_idmutation t4
	ON t.idmutation = t4.idmutation
LEFT JOIN dvf_d62.tmp_calcul_disposition_idmutation t5
...
LEFT JOIN dvf_d59.tmp_calcul_volume_idmutation t2
	ON t.idmutation = t2.idmutation
LEFT JOIN dvf_d59.tmp_calcul_mutation_article_cgi_idmutation t3
	ON t.idmutation = t3.idmutation
LEFT JOIN dvf_d59.tmp_calcul_disposition_parcelle_idmutation t4
	ON t.idmutation = t4.idmutation
LEFT JOIN dvf_d59.tmp_calcul_disposition_idmutation t5
	ON t.idmutation = t5.idmutation
