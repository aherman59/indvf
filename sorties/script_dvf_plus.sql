...
--
-- Début d'exécution le 05/08/2016 à 13:38:07
---
...
LEFT JOIN dvf_d62.tmp_calcul_ann_nature_mutation_idmutation t0
	ON t.idmutation = t0.idmutation
LEFT JOIN dvf_d62.tmp_calcul_annexes_idmutation t1
	ON t.idmutation = t1.idmutation
LEFT JOIN dvf_d62.tmp_calcul_local_idmutation t2
	ON t.idmutation = t2.idmutation
LEFT JOIN dvf_d62.tmp_calcul_disposition_idmutation t3
...
LEFT JOIN dvf_d62.tmp_calcul_suf_idmutation t7
...
LEFT JOIN dvf_d59.tmp_calcul_ann_nature_mutation_idmutation t0
	ON t.idmutation = t0.idmutation
LEFT JOIN dvf_d59.tmp_calcul_annexes_idmutation t1
	ON t.idmutation = t1.idmutation
LEFT JOIN dvf_d59.tmp_calcul_local_idmutation t2
	ON t.idmutation = t2.idmutation
LEFT JOIN dvf_d59.tmp_calcul_disposition_idmutation t3
	ON t.idmutation = t3.idmutation
...
LEFT JOIN dvf_d59.tmp_calcul_disposition_parcelle_idmutation t6
	ON t.idmutation = t6.idmutation
LEFT JOIN dvf_d59.tmp_calcul_suf_idmutation t7
	ON t.idmutation = t7.idmutation
);
SELECT tablename 
FROM pg_tables 
