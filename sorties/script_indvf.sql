...
FROM (
	SELECT * 
	FROM dvf.mutation
	WHERE l_codinsee && ARRAY['59183']::VARCHAR[] AND anneemut >= 2001 AND anneemut <= 2015
	) t
;
...
FROM (
	SELECT *  
	FROM dvf.mutation 
	WHERE l_codinsee && ARRAY['59183']::VARCHAR[] 
	) t
...
FROM (
	SELECT * 
	FROM dvf.mutation
	WHERE l_codinsee && ARRAY['59183']::VARCHAR[] AND anneemut >= 2005 AND anneemut <= 2015
	) t
;
...
FROM (
	SELECT * 
	FROM dvf.mutation
	WHERE l_codinsee && ARRAY['62001']::VARCHAR[] AND anneemut >= 2005 AND anneemut <= 2015
	) t
;
...
FROM (
	SELECT *  
	FROM dvf.mutation 
	WHERE l_codinsee && ARRAY['62001']::VARCHAR[] 
	) t
...
FROM (
	SELECT * 
	FROM dvf.mutation
	WHERE l_codinsee && ARRAY['59009']::VARCHAR[] AND anneemut >= 2005 AND anneemut <= 2015
	) t
;
...
FROM (
	SELECT * 
	FROM dvf.mutation
	WHERE l_codinsee && ARRAY['62003']::VARCHAR[] AND anneemut >= 2005 AND anneemut <= 2015
	) t
;
...
FROM (
	SELECT *  
	FROM dvf.mutation 
	WHERE l_codinsee && ARRAY['59009']::VARCHAR[] 
	) t
...
FROM (
	SELECT *  
	FROM dvf.mutation 
	WHERE l_codinsee && ARRAY['62003']::VARCHAR[] 
	) t
