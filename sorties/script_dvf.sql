...
--
-- Début d'exécution le 22/07/2016 à 10:31:03
---
...
(
    ...
    FROM source.tmp_0 t
    LEFT JOIN dvf.adresse t6 ON t.idadr_tmp=t6.idadrinvar AND t.idadr_tmp not like '%$$$$%' -- eviter les pbs d adresses non renseignees pour contraintes d unicites
