...
--
-- Début d'exécution le 05/10/2016 à 10:15:20
---
...
COMMENT ON COLUMN dvf_d62.parcelle.idpar IS 'identifiant de la parcelle (idem Fichiers fonciers)';
...
COMMENT ON COLUMN dvf_d62.local.idpar IS 'identifiant de la parcelle (idem Fichiers fonciers)';

COMMENT ON COLUMN dvf_d62.local.coddep IS 'code du département';

COMMENT ON COLUMN dvf_d62.local.iddispoloc IS 'identifiant de clef primaire de la table local';
...
COMMENT ON COLUMN dvf_d59.parcelle.idpar IS 'identifiant de la parcelle (idem Fichiers fonciers)';
...
COMMENT ON COLUMN dvf_d59.local.idpar IS 'identifiant de la parcelle (idem Fichiers fonciers)';

COMMENT ON COLUMN dvf_d59.local.coddep IS 'code du département';

COMMENT ON COLUMN dvf_d59.local.iddispoloc IS 'identifiant de clef primaire de la table local';
...
--
--
-- IMPORT DES FICHIERS ANNEXES C:\Users\antoine.herman\Desktop\python_env\django_env\lib\site-packages\dvf_plus\ressources\natcult.csv, C:\Users\antoine.herman\Desktop\python_env\django_env\lib\site-packages\dvf_plus\ressources\natcultspe.csv, C:\Users\antoine.herman\Desktop\python_env\django_env\lib\site-packages\dvf_plus\ressources\artcgil135b.csv PAR UNE INSTRUCTION "COPY FROM"--
--
--
--
--
...
(
    ...
    FROM source.tmp_0 t
    LEFT JOIN dvf.adresse t6 ON t.idadr_tmp=t6.idadrinvar -- AND t.idadr_tmp not like '%$$$$%' -- eviter les pbs d adresses non renseignees pour contraintes d unicites (ID Bertrand à etudier - m'a fait planter le script / j'aurai tendance a le mettre sur la ligne du dessous)
