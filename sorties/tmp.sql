...
SELECT DISTINCT coddep || codcomm as codinsee FROM dvf.disposition_parcelle WHERE coddep = '59' ORDER BY codinsee;SELECT DISTINCT coddep || codcomm as codinsee FROM dvf.disposition_parcelle WHERE coddep = '59' ORDER BY codinsee;